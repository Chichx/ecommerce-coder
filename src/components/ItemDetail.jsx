    ...
    <>
      <div className="bg-[#2d2d2d] w-96 rounded-xl p-6">
                ...
                return (
                  <div key={key} className="flex items-center">
                    <svg
                      ...
                      className="icon icon-tabler icon-tabler-paperclip text-orange-400 mr-4"
                      width="15"
                      height="16"
                      viewBox="0 0 24 24"
                      strokeWidth="2"
                    ...
                    <p className="text-gray-200 font-medium text-base mt-2">{`${
        ...
        <div className="flex items-center">
          ...
          <p className="text-gray-200 font-medium text-base mt-2">{`Stock: ${stock}`}</p>
        </div>
        <div className="w-full h-[1px] bg-gray-500 my-4"></div>

        <ItemCounter onAdd={add} product={item} quantity={1} />
      </div>
      ...
      <div className="relative flex flex-col">
        ...
        <svg
          aria-hidden="true"
          viewBox="0 0 418 42"
          className="absolute top-12 text-center  w-[500px] fill-orange-400/90  z-[-1]"
        ...
        <p className="font-medium text-lg max-w-lg text-zinc-400 mt-10">
          {item.description}
        </p>
      </div>
    </>
